...
from hub.games.tetris.components import Tetromino
from hub.games.tetris.constants import (
    GRID_WIDTH, GRID_HEIGHT, CELL_SIZE,
    FALL_INTERVAL, FAST_FALL_INTERVAL, LINE_CLEAR_BASE_SCORE,
    SHAPES, SHAPE_COLORS
)
...
class TetrisGameModular(BaseGameModular):
    """Modular Tetris game implementation."""
    ...
    def __init__(
        ...
        """Initialize Tetris game with dependency injection."""
        super().__init__(display_manager, input_service, audio_service, event_bus, "Tetris")
    ...
    def clear_lines(self) -> None:
        ...
        if lines_to_clear:
            ...
            # Score: base * lines^2
            self.score += LINE_CLEAR_BASE_SCORE * len(lines_to_clear) * len(lines_to_clear)
    ...
    def update_game(self, dt: float) -> None:
        ...
        elif self.input_service.is_key_pressed(pygame.K_DOWN):
            # Fast fall
            self.fall_interval = FAST_FALL_INTERVAL
        else:
            self.fall_interval = FALL_INTERVAL
